...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='contiene informacion de los caballos';
...
INSERT INTO `caballo` VALUES (1,'algunos30','A'),(2,'black killer','A'),(3,'Sorprendente','A'),(5,'Disney mio','A'),(6,'Jeremy nuevo','A'),(7,'cocodrilo','A');
...
CREATE TABLE `carrera` (
  ...
  CONSTRAINT `Fk_caballo` FOREIGN KEY (`idcaballo`) REFERENCES `caballo` (`idcaballo`),
  CONSTRAINT `FK_cuidador` FOREIGN KEY (`idcuidador`) REFERENCES `cuidador` (`idcuidador`),
  CONSTRAINT `FK_jockey` FOREIGN KEY (`idjockey`) REFERENCES `jockey` (`idjockey`)
...
INSERT INTO `carrera` VALUES (1,1,1,1,56,300,'2023-10-28'),(1,2,1,1,56,300,'2023-10-28'),(2,1,1,1,56,250,'2023-10-28'),(2,2,1,2,56,350,'2023-10-19'),(2,2,1,1,56,250,'2023-10-28'),(3,1,2,1,56,240,'2023-10-28'),(3,2,2,1,56,240,'2023-10-28');
...
CREATE TABLE `cuidador` (
  ...
  CONSTRAINT `localidad` FOREIGN KEY (`idlocalidad`) REFERENCES `localidad` (`idlocalidad`)
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='datos de los cuidadores';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `cuidador` VALUES (1,'Norberto',5,'A'),(2,'oo',3,'A'),(3,'Nego blaid',3,'A'),(14,'Carlos',3,'A'),(15,'Carlos',3,'A'),(16,'Alexis',3,'A'),(17,'Norberto',4,'A'),(18,'Carlos',4,'A'),(19,'Carlos',5,'A');
...
INSERT INTO `jockey` VALUES (1,'Norberto','algo','3755-609040',47),(2,'Carlos','nada','3755213243',56),(6,'Jerónimo','calle 25 de mayo 1079','3647777888',40),(7,'Jose','sdfsdf','2222',42);
...
) ENGINE=InnoDB AUTO_INCREMENT=31 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='lista de localidades';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `localidad` VALUES (1,'Posadas'),(3,'Oberá'),(4,'San Vicente'),(5,'Aristobulo');
...
INSERT INTO `remates` VALUES (1,1,233.00,3344.00,4,'A','2023-10-28'),(2,1,1750.00,6666.00,2,'A','2023-10-28'),(3,1,2345.00,33444.00,3,'B','2023-10-19'),(4,2,2333.00,3222.00,2,'A','2023-10-11'),(5,7,2333.00,32345.00,1,'A','2023-10-13'),(6,2,2134.00,2233.00,3,'A','2023-10-28'),(7,1,5000.00,5200.00,1,'A','2023-10-06');
...
-- Dump completed on 2023-10-28 20:05:45
